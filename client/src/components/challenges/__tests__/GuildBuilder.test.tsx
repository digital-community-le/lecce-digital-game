...
describe('GuildBuilder getSuggestion Function', () => {
  ...
  const questText =
    'Migliora la visibilità sui social con una squadra bilanciata';
  ...
  it('should return different suggestions for different roles', () => {
    const developerSuggestion = getSuggestion(
      'Developer',
      requiredRoles,
      questText,
      []
    );
    const testerSuggestion = getSuggestion(
      'Tester',
      requiredRoles,
      questText,
      []
  ...
  it('should provide consistent suggestions for same inputs', () => {
    const suggestion1 = getSuggestion(
      'Developer',
      requiredRoles,
      questText,
      []
    );
    const suggestion2 = getSuggestion(
      'Developer',
      requiredRoles,
      questText,
      []
