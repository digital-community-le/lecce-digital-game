...
const ChallengeLayout: React.FC<ChallengeLayoutProps> = ({
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="nes-container is-rounded p-6">
          ...
          <p className="mb-4">
            Per partecipare a questa challenge devi prima creare un profilo.
          </p>
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="nes-container is-rounded p-6">
          ...
          <button className="nes-btn" onClick={() => setLocation('/game/map')}>
            Torna alla mappa
          </button>
        </div>
      </div>
    ...
    return (
      <div className="container mx-auto px-4 py-6">
        <div className="nes-container is-rounded p-6">
          ...
          <p className="mb-4">
            Devi completare le challenge precedenti per sbloccare questa sfida.
          </p>
          <div className="flex gap-2">
            <button
              className="nes-btn"
  ...
  return (
    <>
      ...
      <nav className="border-b-4 border-border sticky top-[56px] bg-background z-10">
